...
CREATE TABLE IF NOT EXISTS `tb_vendas` (
  ...
  INDEX `tb_cliente_id_cliente` (`id_cliente` ASC) VISIBLE,
  INDEX `tb_funcionario_id_funcionario` (`id_funcionario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `tb_itens_vendas` (
  ...
  INDEX `fk_tb_vendas_has_tb_produto_tb_produto1_idx` (`id_produto` ASC) VISIBLE,
  INDEX `fk_tb_vendas_has_tb_produto_tb_vendas1_idx` (`id_vendas` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `tb_itens_carrinho` (
  ...
  INDEX `fk_tb_carrinho_has_tb_produto_tb_produto1_idx` (`id_produto` ASC) VISIBLE,
  INDEX `fk_tb_carrinho_has_tb_produto_tb_carrinho1_idx` (`id_carrinho` ASC) VISIBLE,
